...
{
    /// <inheritdoc />
    public partial class AddPuzzleQuestion : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "response_puzzle_placements",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_response_puzzle_placements", x => x.id);
                    table.ForeignKey(
                        name: "fk_response_puzzle_placements_question_responses_response_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_response_puzzle_placements_response_id",
                table: "response_puzzle_placements",
                column: "response_id");
        }
